        ...
        <div class="row login-container">
            ...
            <div class="col-md-6 login-form">
                <div class="login-icon">
                    <img src="/images/banks/game-logo.jpg" alt="Coin Icon" style="width: 100px; height: 100px; border-radius: 50%;">
                </div>
                ...
                <form>
                    ...
                    <div class="mb-2 position-relative">
                        ...
                        <span class="password-toggle" onclick="togglePassword()" style="padding-top: 30px; padding-right: 10px;">
